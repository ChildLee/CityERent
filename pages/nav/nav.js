...
Page({
  data: {
    ...
    city: [
      {
        sort: '热门城市',
        list: [{ID: '440300', Name: '深圳'}, {ID: '110100', Name: '北京'}, {ID: '310100', Name: '上海'}, {
          ID: '440100',
          Name: '广州'
        }]
      },
      ...
      {
        sort: 'H',
        list: [{ID: '330100', Name: '杭州'}, {ID: '441300', Name: '惠州'}, {ID: '460100', Name: '海口'}, {
          ID: '340100',
          Name: '合肥'
        }]
      },
      ...
      {
        sort: 'S',
        list: [{ID: '310100', Name: '上海'}, {ID: '440300', Name: '深圳'}, {ID: '320500', Name: '苏州'}, {
          ID: '130100',
          Name: '石家庄'
        }, {ID: '210100', Name: '沈阳'}]
      },
